                            ...
                            <tbody>
                                <?php $no = 1; foreach ($prodi as $p) { ?>
                                    <tr>
                                        ...
                                        <td><?= $p->nama_prodi ?></td>
                                        <td>
                                            <a href="<?= base_url('prodi/ubah/' . $p->id) ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Ubah</a>
                                            <a href="<?= base_url('prodi/hapus/' . $p->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Ingin hapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
